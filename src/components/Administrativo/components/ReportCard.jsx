    ...
    <div className={`rounded-lg shadow hover:shadow-md transition-shadow ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
      ...
      <div className="p-4">
        ...
        <div className="text-sm mb-3">
          ...
          <span className={`font-medium ${darkMode ? 'text-gray-200' : 'text-gray-900'}`}>{reporte.fechaEntrega || "Sin entregar"}</span>
        </div>
        ...
        <div className="flex justify-end">
          ...
          >
            {reporte.isPending ? "Sin entregar" : reporte.status === "En revisión" ? "Revisar" : "Ver detalles"}
          </button>
        </div>
      </div>
    </div>
